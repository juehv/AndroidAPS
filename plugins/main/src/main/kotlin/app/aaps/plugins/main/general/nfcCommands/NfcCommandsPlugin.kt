...
class NfcCommandsPlugin
    ...
    constructor(
        ...
        private fun processProfile(divided: List<String>): NfcExecutionResult {
            ...
            val profileStore =
                activePlugin.activeProfileSource.profile
                    ?: return NfcExecutionResult(false, rh.gs(app.aaps.core.ui.R.string.notconfigured))
                        ...
                        if (result.success) {
                            ...
                            if (isMeal) {
                                profileFunction.getProfile()?.let {
                                    ...
                                    disposable +=
                                        persistenceLayer
                                            .insertAndCancelCurrentTemporaryTarget(
                                                temporaryTarget =
                                                    TT(
                                                        timestamp = dateUtil.now(),
        ...
        private fun processTarget(divided: List<String>): NfcExecutionResult {
            ...
            return when {
                ...
                isStop -> {
                    disposable +=
                        persistenceLayer
                            .cancelCurrentTemporaryTargetIfAny(
                                timestamp = dateUtil.now(),
